...
RUN apt-get update && apt-get install -y --no-install-recommends git python3 make build-essential clang cmake libsnappy-dev openssl libpq-dev pkg-config libc6 && rm -rf /var/lib/apt/lists/*
...
RUN apt-get update && apt-get install -y --no-install-recommends git python3 make build-essential && rm -rf /var/lib/apt/lists/*
...
RUN apt-get update && apt-get install -y --no-install-recommends git python3 make build-essential clang cmake libsnappy-dev openssl libpq-dev pkg-config libc6 postgresql-common postgresql-15 && rm -rf /var/lib/apt/lists/*
